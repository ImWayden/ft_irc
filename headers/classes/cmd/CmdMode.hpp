...
/*   Updated: 2025/07/13 21:31:59 by wayden           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
private:
	...
	void handle_k(bool isPlus, Channel *channel, const std::string &channelName, const std::string* parameter, int &parametersUsed, const CommandData &cmd);
	void handle_l(bool isPlus, Channel *channel, const std::string* parameter, int &parametersUsed, const CommandData &cmd);
	void handle_o(bool isPlus, Channel *channel, const std::string &channelName, const std::string* parameter, int &parametersUsed, const CommandData &cmd);
